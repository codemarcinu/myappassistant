...
try:
    ...
    logging.warning("langdetect not installed. Language detection will not work properly.")
...
class LanguageDetector:
    ...
    def __init__(self) -> None:
        ...
        self.language_keywords = {
            "pl": [
                "jest", "nie", "tak", "co", "jak", "dla", "gdzie", "kiedy", 
                "dlaczego", "który", "wszystko", "cześć", "dziękuję", "proszę",
                "przepraszam", "dobrze", "źle", "bardzo", "trochę", "dużo"
            ],
            "en": [
                "is", "not", "yes", "what", "how", "for", "where", "when", 
                "why", "which", "all", "hello", "thank", "please", 
                "sorry", "good", "bad", "very", "little", "much"
            ],
            "de": [
                "ist", "nicht", "ja", "was", "wie", "für", "wo", "wann",
                "warum", "welche", "alles", "hallo", "danke", "bitte",
                "entschuldigung", "gut", "schlecht", "sehr", "wenig", "viel"
            ]
        }
