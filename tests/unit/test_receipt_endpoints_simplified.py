...
class TestReceiptEndpointsSimplified:
    ...
    async def test_receipt_endpoint_invalid_file_type(self):
        ...
        upload_receipt_mock.side_effect = HTTPException(status_code=400, detail=error_detail)
    ...
    async def test_receipt_endpoint_ocr_failure(self):
        ...
        upload_receipt_mock.side_effect = HTTPException(status_code=422, detail=error_detail)
